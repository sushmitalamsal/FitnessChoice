        ...
        child: ListView(children: <Widget>[
          Padding(
            ...
            child: Column(
              children: <Widget>[
                Text(
                  "The ketogenic diet, popularly referred to as the Keto diet, is an eating regimen that is high in healthy fats, moderate in protein, "
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(children: <Widget>[
                      Text(
                        "4. Potentially reduces seizures\n "
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(children: <Widget>[
                      Text(
                        " The keto diet can cause adverse side effects that many people know as keto flu."
