                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                          children: [
                            Text('$drankWater ml', style: TextStyle(fontSize: 25),),

                            RaisedButton(onPressed: () {
                              Provider.of<DrinkWaterProvider>(
                                  context, listen: false).storeDrankWaterDetail(
                                  200);
                            },
                              child: Text('Add water' , style: TextStyle(fontSize: 25),),
