                    ...
                    Container(
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              "Healthy Chorizo Guacamole Bunless Burger",
                              style: TextStyle(
                                fontSize: 20,
                              ),
                            )
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              "1. 1 large ripe avocado (200 g/ 7.1 oz)\n "
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              "1. 4 Mexican chorizo sausages, casing removed (250 g/ 8.8 oz)\n "
                              "2. 400 g ground beef (14.1 oz)\n "
                              "3. 1 tbsp ghee or lard (15 g/ 0.5 oz)\n"
                              "4. 1 head crispy lettuce such as little gem or romaine (200 g/ 7.1 oz)",
                              style: TextStyle(
                                fontSize: 20,
                              ),
                            )
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                                "1. Prepare the guacamole. Halve and peel the avocado. Remove the pit"
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              "1. 1 lb boneless chicken breasts or thighs\n "
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              "1. Whisk all the ingredients for the sauce and set aside. \n \n"
                              ...
                              " Serve with rice or noodles; garnish with sesame seeds if desired. ",
                              textAlign: TextAlign.justify,
                              style: TextStyle(
                                fontSize: 20,
                                wordSpacing: 2.0,
