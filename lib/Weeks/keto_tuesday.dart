                  ...
                  fontWeight: FontWeight.bold,
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text("Scrambled Eggs with Pumpkin Seeds and Peanuts", style: TextStyle(
                              fontSize: 20,
                            ),)
                          ],
                        ),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text("1. Toast the pumpkin seeds in a pan, stirring constantly so "
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text("1. 2 cups chopped, cooked chicken\n  "
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text("1. Use a rotisserie chicken or any leftover chicken that you have on hand \n \n"
                                "2. Season two small chicken breasts with salt and pepper and cook them in a bit"
                                " of olive oil in a skillet over medium heat \n \n"
                                "3. Combine all ingredients in a large bowl and serve.",  textAlign: TextAlign.justify,style:
                            TextStyle(fontSize: 20,
                              wordSpacing: 2.0,
                            ),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text("Beef stew made with mushroom" ,
                              style: TextStyle(
                                fontSize: 20,
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text("INGREDIENTS: \n"
                                "For 10 Servings   ", style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.bold,
                            ),)
                          ],
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text("1. 2 strips thick-cut bacon, chopped\n "
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text( "1. Chop all the meat and produce, except the potatoes. Set a large soup pot over medium heat."
                          ...
                          children: <Widget>[
                            Text(
                              "Calories: 265 kcal \n"
                                  ...
                                  "Carbohydrates: 19mg \n "
                                  "Fiber: 3g \n"
                                  "Cholesterol: 51mg" , style: TextStyle(
                              fontSize: 20,
